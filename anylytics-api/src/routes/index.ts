...
//     // qs = 'where={"token_id":{"$eq": 1275}}';

//     const table = "nfts2";
//     // const url = `https://${config.dbId}-${config.region}.apps.astra.datastax.com/api/rest/v2/schemas/keyspaces/${config.keyspace}/${table}`;
//     const url = `https://${config.dbId}-${config.region}.apps.astra.datastax.com/api/rest/v2/keyspaces/${config.keyspace}/${table}?${qs}`;
